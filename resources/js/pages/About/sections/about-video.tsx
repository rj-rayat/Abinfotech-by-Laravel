...
export default function AboutVideoSection() {
  ...
  return (
    <section className="relative py-24 bg-background text-foreground overflow-hidden">
      ...
      {/* 🌌 ব্যাকগ্রাউন্ড অ্যাম্বিয়েন্ট গ্লো (ডার্ক মুডে গভীরতা বাড়ানোর জন্য) */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* ভিডিও থাম্বনেইল কার্ড - বর্ডার টেমপ্লেট ডার্ক ফ্রেন্ডলি করা হয়েছে */}
            <div className="relative rounded-[2.5rem] overflow-hidden border-4 md:border-8 border-card dark:border-white/[0.05] shadow-2xl shadow-indigo-500/5 dark:shadow-black/60 aspect-video bg-muted/30 backdrop-blur-md">
              ...
              {/* প্লে বাটন ও ডাইনামিক পালস ইম্প্যাক্ট */}
          ...
          <div className="relative">
            <motion.div
              ...
              transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            >
              {/* মডার্ন সাব-হেডিং ব্যাজ */}
              <div className="flex items-center gap-3 mb-6">
                <div className="h-[2px] w-10 bg-indigo-600 dark:bg-indigo-500"></div>
                <span className="text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-[0.2em] text-xs md:text-sm">About Us</span>
              </div>

              {/* মেইন হেডিং উইথ গ্রেডিয়েন্ট টেক্সট */}
              <h2 className="text-4xl md:text-6xl font-black font-blinker tracking-tight text-foreground mb-8 leading-none uppercase">
                Welcome to <br />
              ...
              {/* ডেসক্রিপশন টেক্সট - text-muted-foreground দিয়ে অপ্টিমাইজড */}
              ...
              {/* কন্টাক্ট বাটন উইথ শ্যাডো ফিক্স */}
              <div className="mt-10">
                <button className="px-10 py-5 bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-600 text-white font-bold rounded-2xl shadow-xl shadow-indigo-600/10 dark:shadow-indigo-500/5 hover:shadow-indigo-500/20 transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 group">
                  Contact Us
