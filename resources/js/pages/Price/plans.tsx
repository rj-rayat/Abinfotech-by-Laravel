      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-1 p-1.5 bg-white border border-slate-100 shadow-sm rounded-2xl">
            ...
            >
              Yearly
              <span className="text-[10px] bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-md font-black uppercase">Save Big</span>
            </button>
          </div>
        </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mb-8 pb-8 border-b border-slate-50">
                    ...
                    <span className="text-slate-400 font-medium text-sm">/ {displayPeriod}</span>
                  </div>
                  ...
                  <ul className="space-y-4 mb-10">
                    {plan.features && plan.features.map((feature, i) => (
                      <li key={i} className="flex items-center gap-3 text-slate-600 text-sm font-medium group">
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-none ${isPopular ? 'bg-indigo-50 text-indigo-600' : 'bg-slate-50 text-slate-500'}`}>
