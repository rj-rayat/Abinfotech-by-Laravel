      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-foreground tracking-tight uppercase font-blinker">
        ...
        <div className="overflow-visible" ref={emblaRef}>
          <div className="flex -ml-6">
            {testimonials.map((review) => {
              ...
              const avatarSrc = review.image?.startsWith('/') || review.image?.startsWith('http')
                ? review.image
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-border/60 group-hover:border-white/20 transition-colors">
                      {review.image ? (
                        ...
                        <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold bg-indigo-50 text-indigo-600 border dark:bg-slate-800 dark:text-sky-400 group-hover:bg-white/20 group-hover:text-white transition-all shadow-md">
