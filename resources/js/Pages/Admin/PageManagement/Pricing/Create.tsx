...
export default function Create({ plan }: Props) {
        ...
        <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-card overflow-hidden shadow-sm sm:rounded-2xl p-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <Link href={route('admin.pricing.index')} className="p-2 bg-white hover:bg-slate-100 rounded-xl border border-slate-200 transition-colors">
                <ArrowLeft size={16} className="text-slate-600" />
              </Link>
              <h1 className="text-xl font-black text-foreground">Create Pricing Plan</h1>
            </div>
                  ...
                  {data.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <input
                        ...
                        placeholder={`Feature #${index + 1} (e.g., 50GB Disk Space)`}
                        required
                      />
